...
//建立SQL
$sql = " INSERT INTO LangTu.project(fundContent, fundName, fundImg, fundDate, fundEndDate, fundTopContent, fundStatus) values (:note, :title, :image, :dateStart, :dateEnd, :content, :status)  ";
